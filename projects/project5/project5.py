...
if monthDays > 32:
    print('Error. too any days in month')
elif monthDays < 28:
    print('Error. not enough days in month')
...
if monthStart_input == 'sunday':
    date = 1
elif monthStart_input == 'monday':
    date = 0
elif monthStart_input == 'tuesday':
    date = -1
elif monthStart_input == 'wednesday':
    date = -2
elif monthStart_input == 'thursday':
    date = -3
elif monthStart_input == 'friday':
    date = -4
elif monthStart_input == 'saturday':
    date = -5
